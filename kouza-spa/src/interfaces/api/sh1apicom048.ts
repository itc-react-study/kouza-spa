...
/**
 * API ID: SH1APICOM048。
 * 業務データ明細照会(口座)APIのリクエスト・ボディ。
 *
 * @author Charlie
 */
export interface SH1APICOM048RequestBody extends ApiRequestBodyBase {
  /**
   * 項目名: 受付番号
   * キー必須: Y | 値必須: Y
   */
...
/**
 * API ID: SH1APICOM048。
 * 業務データ明細照会(口座)APIのレスポンス・ボディ。
 *
 * @author Charlie
 */
export interface SH1APICOM048ResponseBody extends ApiResponseBodyBase {
  data: {
    /**
     * 項目名: 顧客受付情報
     * キー必須: Y | 値必須: Y
    ...
    customerInformation: {
       ...
       * キー必須: N | 値必須: N
       */
      customerNameKanjiReviewModifiedFlag?: string;
       ...
       * キー必須: N | 値必須: N
       */
      customerNameKanaReviewModifiedFlag?: string;

      /**
       * 項目名: 名前（英字）
       * キー必須: N | 値必須: N
       */
      customerNameRoma?: string;
       ...
       * キー必須: N | 値必須: N
       */
      customerNameRomaReviewModifiedFlag?: string;
       ...
       * キー必須: N | 値必須: N
       */
      postNoReviewModifiedFlag?: string;
       ...
       * キー必須: N | 値必須: N
       */
      addrKanjiReviewModifiedFlag?: string;
       ...
       * キー必須: N | 値必須: N
       */
      addrKanaReviewModifiedFlag?: string;
       ...
       * キー必須: N | 値必須: N
       */
      birthdayReviewModifiedFlag?: string;
    ...
    eventBeforeTabInfo?: {
      ...
      cifAccountList?: {
         ...
         * キー必須: N | 値必須: N
         */
        designatedAccountRegistFlg?: string;
    ...
    syouhinSelectTabInfo?: {
       ...
       * キー必須: N | 値必須: N
       */
      storeSelectReason?: string;

      /**
       * 項目名: 保有口座有無
       * キー必須: N | 値必須: N
       */
      existAccountHold?: string;
    ...
    errorTabInfo?: {
       ...
       * キー必須: N | 値必須: N
       */
      passwordCashcard?: string;

      /**
       * 項目名: ダイレクト暗証番号
       * キー必須: N | 値必須: N
       */
      passwordBtmud?: string;
